...
package net.william278.huskhomes.universal.impl.v12111;
...
public final class V12111MinecraftVersionAdapter implements MinecraftVersionAdapter {
    ...
    public String describe() {
        return "Universal adapter for Minecraft 1.21.11 using respawn data and entity world APIs";
    }
    ...
    public void setWorldSpawn(@NotNull Object serverWorld, @NotNull SpawnPosition spawnPosition) {
        ...
        world.setSpawnPoint(net.minecraft.world.WorldProperties.SpawnPoint.create(
    ...
    public String getPlayerName(@NotNull Object player) {
        return ((ServerPlayerEntity) player).getGameProfile().name();
    }
    ...
    public PlayerPosition getPlayerPosition(@NotNull Object player) {
        ...
        final net.minecraft.util.math.Vec3d position = serverPlayer.getEntityPos();
    ...
    public Optional<RespawnPosition> getRespawnPosition(@NotNull Object player) {
        ...
        return Optional.of(new RespawnPosition(
                serverPlayer.getRespawn().respawnData().getPos().getX(),
                serverPlayer.getRespawn().respawnData().getPos().getY(),
                serverPlayer.getRespawn().respawnData().getPos().getZ(),
                serverPlayer.getRespawn().respawnData().yaw(),
                serverPlayer.getRespawn().respawnData().getDimension().getValue().toString()
        ));
    }
}

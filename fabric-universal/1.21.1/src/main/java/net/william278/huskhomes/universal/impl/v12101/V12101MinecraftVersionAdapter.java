...
public final class V12101MinecraftVersionAdapter implements MinecraftVersionAdapter {
    ...
    public String describe() {
        return "Universal adapter for Minecraft 1.21.1 using spawn point and legacy player access APIs";
    }
    ...
    public Optional<RespawnPosition> getRespawnPosition(@NotNull Object player) {
        final ServerPlayerEntity serverPlayer = (ServerPlayerEntity) player;
        final BlockPos spawn = serverPlayer.getSpawnPointPosition();
        final RegistryKey<net.minecraft.world.World> world = serverPlayer.getSpawnPointDimension();
